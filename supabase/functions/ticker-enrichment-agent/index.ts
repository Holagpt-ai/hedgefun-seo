...
function sicDescriptionToSector(desc) {
  if (!desc) return null;
  const d = desc.toUpperCase();
  if (d.includes("PHARMACEUTICAL") || d.includes("MEDICAL") || d.includes("HOSPITAL") || d.includes("HEALTH") || d.includes("SURGICAL") || d.includes("BIOLOGICAL") || d.includes("DIAGNOSTIC") || d.includes("ORTHOPEDIC") || d.includes("ELECTROMEDICAL")) return "Healthcare";
  if (d.includes("SOFTWARE") || d.includes("SEMICONDUCTOR") || d.includes("COMPUTER") || d.includes("DATA PROCESSING") || d.includes("OPTICAL INSTRUMENTS") || d.includes("MEASURING") || d.includes("ELECTRONIC COMPONENTS")) return "Technology";
  if (d.includes("BANK") || d.includes("INSURANCE") || d.includes("BROKER") || d.includes("INVESTMENT") || d.includes("FINANCE") || d.includes("CREDIT") || d.includes("SECURITY BROKERS") || d.includes("SURETY")) return "Financials";
  if (d.includes("PETROLEUM") || d.includes("OIL") || d.includes("GAS FIELD") || d.includes("CRUDE") || d.includes("DRILLING") || d.includes("NATURAL GAS TRANSMISSION")) return "Energy";
  if (d.includes("RAILROAD") || d.includes("AIRCRAFT") || d.includes("TRUCKING") || d.includes("TRANSPORTATION") || d.includes("COURIER") || d.includes("MACHINERY") || d.includes("ENGINES") || d.includes("REFUSE") || d.includes("GUIDED MISSILES")) return "Industrials";
  ...
  if (d.includes("TELEPHONE") || d.includes("CABLE") || d.includes("RADIOTELEPHONE") || d.includes("BROADCASTING")) return "Communication Services";
  if (d.includes("RETAIL") || d.includes("HOTEL") || d.includes("MOTEL") || d.includes("AMUSEMENT") || d.includes("EATING")) return "Consumer Discretionary";
  if (d.includes("TOBACCO") || d.includes("FOOD") || d.includes("GROCERY") || d.includes("BEVERAGE") || d.includes("CIGARETTE") || d.includes("SOFT DRINKS")) return "Consumer Staples";
  if (d.includes("MINING") || d.includes("METALS") || d.includes("CHEMICALS") || d.includes("GOLD") || d.includes("SILVER") || d.includes("WIRE") || d.includes("SOAP")) return "Materials";
  return null;
}
